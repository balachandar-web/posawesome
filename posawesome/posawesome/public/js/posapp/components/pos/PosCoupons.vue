...
export default {
  ...
  created: function () {
    this.$nextTick(function () {
      ...
      // Initialize customer from store if available
      if (customerStore && customerStore.state && customerStore.state.selectedCustomer) {
        console.log('PosCoupons.vue: Initializing customer from store:', customerStore.state.selectedCustomer);
    ...
    this.eventBus.on('update_customer', (customer) => {
      if (this.customer != customer) {
        ...
        if (customerStore && typeof customerStore.dispatch === 'function') {
          console.log('PosCoupons.vue: Syncing with customer store');
