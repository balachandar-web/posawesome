        ...
        frappe.call({
          ...
          callback: (r) => {
            if (!r.exc && r.message.name) {
              ...
              // Update customer store directly instead of relying only on events
              customerStore.dispatch('fetchCustomers').then(() => {
                // Select the newly created/updated customer
                customerStore.dispatch('selectCustomer', r.message.name);
